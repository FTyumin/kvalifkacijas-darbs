            ...
            <form method="POST" action="{{ route('quiz.store') }}">
                ...
                <div class="mb-8 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-blue-300 text-sm font-medium mb-1">Pro Tip</p>
                            <p class="text-blue-200/80 text-sm">Select at least 3 genres to get better recommendations. You can always update your preferences later!</p>
                        </div>
                    </div>
                </div>
